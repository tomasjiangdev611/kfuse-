...
import LogsTableFullViewTable from './LogsTableFullViewTable';
...
const LogsTableFullView = ({ close, date, workbooks }: Props) => {
...
export default LogsTableFullView;
